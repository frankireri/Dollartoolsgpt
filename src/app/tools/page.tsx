                                ...
                                >
                                    <div className="flex items-start justify-between mb-4">
                                        <div className="w-12 h-12 bg-accent/10 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
                                            {tool.icon === "Sparkles" ? <Sparkles className="w-6 h-6 text-accent" /> : <Sparkles className="w-6 h-6 text-accent" />}
        ...
        <div className="min-h-screen p-8">
            <Suspense fallback={
                <div className="max-w-7xl mx-auto space-y-12 animate-pulse">
                    <div className="h-40 bg-accent/5 rounded-3xl" />
                    <div className="h-80 bg-accent/5 rounded-3xl" />
                </div>
            }>
                <ToolsContent />
            </Suspense>
